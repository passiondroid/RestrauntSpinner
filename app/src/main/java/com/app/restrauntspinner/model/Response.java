...
public class Response implements Parcelable {
    ...
    protected Response(Parcel in) {
        headerLocation = in.readString();
        headerFullLocation = in.readString();
        headerLocationGranularity = in.readString();
        totalResults = in.readByte() == 0x00 ? null : in.readInt();
        suggestedBounds = (SuggestedBounds) in.readValue(SuggestedBounds.class.getClassLoader());
        if (in.readByte() == 0x01) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(headerLocation);
        dest.writeString(headerFullLocation);
        dest.writeString(headerLocationGranularity);
